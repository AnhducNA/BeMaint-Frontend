...
import { PendingActions, Inventory } from "@mui/icons-material";

interface SidebarProps {
  sidebarOpen: boolean;
  setSidebarOpen: (arg: boolean) => void;
  onAddTab: (tab: { label: string; route: string }) => void;
}
    ...
    menuItems: [
      {
        ...
        children: [
          ...
          { label: "Dashboard user", route: "/dashboard/user" },
        ],
      },
      {
        icon: <DeviceHubIcon />,
        ...
        route: "#",
        children: [
          { label: "Real time", route: "/tables" },
          { label: "Thông tin máy", route: "/tables" },
          { label: "Thêm thông tin máy", route: "/forms/form-layout" },
          { label: "Thông số máy", route: "/tables" },
          { label: "Thêm thông số máy", route: "/forms/form-layout" },
          { label: "Kế hoạch bảo trì", route: "/tables" },
        ],
      },
      {
        icon: <PendingActions />,
        ...
        route: "#",
        children: [
          { label: "Bảo trì", route: "/tables" },
          { label: "Sửa chữa", route: "/tables" },
          { label: "Đấu thầu bảo trì, sửa chữa", route: "/tables" },
          { label: "Lịch sử bảo trì, sửa chữa", route: "/tables" },
        ],
      },
      {
        icon: <Inventory/>,
...
const Sidebar = ({ sidebarOpen, setSidebarOpen, onAddTab }: SidebarProps) => {
